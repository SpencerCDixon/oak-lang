...
// readChar will give us the next character and advance our position in the
// input string.
...
// isLetter determines the 'language' or our programming language.  Here is the
// place to allow characters like ? or ! in ident names.
